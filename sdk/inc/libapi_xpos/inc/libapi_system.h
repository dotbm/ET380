...
#define SYS_TRACE( ...)	osl_log( "app", 0 , __VA_ARGS__ )
#define SYS_TRACE_BUFF(buff,size,tip) 	osl_log_buff_tip("app",0,buff, size , tip ,1 );
...
Input : file£ºUpgrade file name
		flag£º1 upgrade application and data, 0 upgrade data only
